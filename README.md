Key Components of this webpage:

1. Header: The webpage greets with a welcome message. 

2. Navigation Bar: It holds the website's logo or title, two links and two buttons.
